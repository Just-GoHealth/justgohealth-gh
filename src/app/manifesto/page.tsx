    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main
        className={`flex-1 flex items-center justify-center px-8 py-20 ${
          isMobile ? "mt-14" : "-mt-14"
        }`}
      >
        <div
          className={`max-w-4xl w-full text-center ${
            isMobile ? "scale-90 -mt-[250px]" : ""
          }`}
        >
          <h1
            className={`text-nowrap font-bold text-red-600 mb-8 mt-14 ${
              isMobile ? "text-3xl -ml-8" : "text-8xl -ml-28"
            }`}
          >
          ...
          <div
            className={`space-y-6 leading-relaxed text-black text-left ${
              isMobile ? "text-xl scale-100" : "text-3xl scale-[1.2]"
            }`}
          >
            <p className="mt-12">
              We, at JustGo Health, promise on our honor to ensure that the
              mental health of every Ghanaian student is{" "}
              <span className="text-red-600 font-bold">
                the best ever, anywhere on earth.
              </span>
              <p className="mt-6">
                {`Our target is clear: to build stronger mental health support in Ghanaian schools than even at Harvard University. On Harvard's campus, a student has`}{" "}
                <span className="text-red-600 font-bold">
                  15 options for mental health care, all digital
                </span>{" "}
                and{" "}
                <span className="text-red-600 font-bold">available 24/7.</span>
              </p>
            </p>
            <p
              className={`text-red-500 font-semibold -mt-4 -mb-4 text-center ${
